 ...
 *
 * Sheet / Logger / API に触らない純関数。GAS へはデプロイせず、ローカルの
 * tools/generateEmptyCellPrediction.js と tools/buildDensityMap.js から使う
 * (GASが使うのは生成結果の lib/survey/EmptyCellPrediction.js だけ)。
 *
